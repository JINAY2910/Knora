                ...
                <main className="flex-1 overflow-y-auto relative scroll-smooth pb-32 bg-cream">
                    ...
                    <div className="max-w-4xl mx-auto px-8 py-16 md:py-20">
                        <div className="mb-12 border-b-2 border-charcoal pb-12">
                            <div className="flex items-center gap-3 mb-6">
                                <span className="px-3 py-1 text-xs font-bold bg-charcoal text-white uppercase tracking-wider flex items-center gap-1">
                                    <span className="material-symbols-outlined text-[14px]">analytics</span> Module Complete
                                </span>
                            </div>
                        ...
                        <div className="prose-custom text-charcoal max-w-none">
                            <p className="mb-6 text-lg leading-relaxed">Modern databases don't just store data; they power real-time analytics. Data Warehouses (OLAP) are optimized for complex read-heavy analytical queries.</p>
        <CalloutBox type="concept">
            <p><strong>OLTP (Online Transaction Processing):</strong> Fast inserts, updates. Normalized (e.g., PostgreSQL).<br/>
            <strong>OLAP (Online Analytical Processing):</strong> Fast complex aggregations. Denormalized, columnar storage (e.g., Snowflake, BigQuery).</p>
        </CalloutBox>
        <h2 className="text-3xl text-charcoal font-sans mb-6 mt-12 border-b-2 border-charcoal pb-2 inline-block">Python Integration</h2>
        <p className="mb-6 text-lg leading-relaxed">Using tools like pandas, SQLAlchemy, and matplotlib, data scientists pull millions of rows from the data warehouse to build predictive models and visual dashboards.</p>
                        </div>
